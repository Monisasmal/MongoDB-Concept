export const metadata = {
  title: "Mongodb Concepts & Projects",
  description:
    "Learn Mongodb concepts with clear explanations, real-world examples, and practical projects.",
};
    ...
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="text-center space-y-4">
        ...
        <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">
          Clear explanations of Mongodb fundamentals, advanced types,
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-12">
        ...
        <div className="border rounded-xl p-5 shadow-sm hover:shadow-md transition">
          ...
          <p className="text-gray-600 text-sm">
            Understand how Mongodb improves code safety and prevents bugs.
          </p>
        </div>
